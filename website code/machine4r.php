...
<?php
    ...
    $query = "SELECT * FROM stats_mach WHERE machid=8;";
...
<body>
    ...
    <div class="title">Machine 4 Right Side</div>
    ...
    <div class="machine_body">
        ...
        <div class="machine_body2">
            ...
            <a href="machine4r.php"><div class="machine_button_R" style="background-color: green;">Machine 4</div></a>
        ...
        <div class="machine_body2" style="width:50%;justify-content:flex-end;align-items:flex-start">
            ...
            <a href="machine4r.php" style="height:15%;width:90%;"><div class="machine_button_L" style="margin:0px;">REFRESH</div></a>
        </div>
