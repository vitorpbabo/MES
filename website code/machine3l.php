...
<?php
    ...
    $query = "SELECT * FROM stats_mach WHERE machid=3;";
    $result = pg_exec($query);
    $row = pg_fetch_assoc($result);

    $query = "SELECT p1p2 + p2p3 + p3p4 + p4p5 + p5p6 + p5p9 + p6p7 + p6p8 AS total  FROM stats_mach WHERE machid=3;";
...
<body>
    ...
    <div class="title">Machine 3 Left Side</div>
    ...
    <div class="machine_body">
        ...
        <div class="machine_body2">
            ...
            <a href="machine3l.php"><div class="machine_button_R" style="background-color: green;">Machine 3</div></a>
        ...
        <div class="machine_body2" style="width:50%;justify-content:flex-end;align-items:flex-start">
            ...
            <a href="machine3l.php" style="height:15%;width:90%;"><div class="machine_button_L" style="margin:0px;">REFRESH</div></a>
        </div>
