...
<?php
    ...
    $query = "SELECT * FROM stats_mach WHERE machid=2;";
    $result = pg_exec($query);
    $row = pg_fetch_assoc($result);

    $query = "SELECT p1p2 + p2p3 + p3p4 + p4p5 + p5p6 + p5p9 + p6p7 + p6p8 AS total  FROM stats_mach WHERE machid=2;";
...
<body>
    ...
    <div class="title">Machine 2 Left Side</div>
    ...
    <div class="machine_body">
        ...
        <div class="machine_body2">
            ...
            <a href="machine2l.php"><div class="machine_button_R" style="background-color: green;">Machine 2</div></a>
        ...
        <div class="machine_body2" style="width:50%;justify-content:flex-end;align-items:flex-start">
            ...
            <a href="machine2l.php" style="height:15%;width:90%;"><div class="machine_button_L" style="margin:0px;">REFRESH</div></a>
        </div>
